...
// 
// @brief 
// This is the Arduino 8x 18650 Smart Charger / Discharger Code - No Barcode Scanner
//
// Current implementation: 
// TP4056, Rotary Encoder KY-040 Module, Temp Sensor DS18B20
// Ethernet Module W5500, LCD 2004 20x4 with IIC/I2C/TWI Serial, Discharge (MilliAmps and MillOhms)
//
...
void loop()
{
  //Nothing else should be in this loop. Use timerObject
  timerObject.update();
}
  ...
  { 
    ...
    case 0: // Check Battery Voltage
      ...
      if (batteryDetectedCount[i] == 5)
      {
        ...
        cycleState[i] = 2; // Check Battery Voltage Completed set cycleState to Charge Battery
      }
      break;
